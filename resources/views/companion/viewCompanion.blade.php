                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade accordion-item border-0" id="Supplements-tab-pane"
                                    role="tabpanel" aria-labelledby="Supplements-tab" tabindex="0">
                                    <div class="text-center">
                                ...
                                <div class="tab-pane fade accordion-item border-0" id="BodyWeight-tab-pane"
                                    role="tabpanel" aria-labelledby="BodyWeight-tab" tabindex="0">
                                    <div class="text-center">
                                ...
                                @if ($companion->sex == 'F')
                                    <div class="tab-pane fade accordion-item border-0" id="Pregnancy-tab-pane"
                                        role="tabpanel" aria-labelledby="Pregnancy-tab" tabindex="0">
                                        <div class="text-center">
