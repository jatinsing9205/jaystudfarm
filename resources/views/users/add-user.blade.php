                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span class="px-2 d-inline-flex align-items-center">
                                            <input type="radio" name="status" value="3" class="mr-2"> Draft
                                        </span>
                                        <span class="px-2 d-inline-flex align-items-center">
                                            <input type="radio" name="status" value="1" class="mr-2"> Active
                                        </span>
                                        <span class="px-2 d-inline-flex align-items-center">
                                            <input type="radio" name="status" value="2" class="mr-2"> Inactive
                                        </span>
